defmodule Pipeline.Metrics.NestedPerformanceTest do
  ...
  describe "record_pipeline_metric/8" do
    test "records pipeline metrics and updates context" do
      ...
      updated_context =
        NestedPerformance.record_pipeline_metric(
          context,
          "test_pipeline",
          # depth
          1,
    ...
    test "accumulates multiple pipeline metrics" do
      ...
      # 3 + 2 + 1
      assert context.summary.total_steps == 6
      ...
      # 500 + 300
      assert depth_1_metrics.total_duration_ms == 800
  ...
  describe "complete_performance_tracking/1" do
    test "completes tracking and calculates final metrics" do
      ...
      assert completed_context.resource_metrics.peak_memory_mb >=
               completed_context.resource_metrics.avg_memory_mb
  ...
  describe "analyze_performance/1" do
    ...
    test "identifies memory bottlenecks" do
      performance_metrics = %{
        ...
        # High memory usage
        resource_metrics: %{peak_memory_mb: 1500.0}
      }
    ...
    test "identifies slow pipeline bottlenecks" do
      ...
      performance_metrics = %{
        ...
        pipeline_metrics: [
          ...
          %{duration_ms: 2500, step_count: 5, pipeline_id: "slow_pipeline"}
        ],
    ...
    test "identifies deep nesting bottlenecks" do
      performance_metrics = %{
        # Deep nesting
        summary: %{total_pipelines: 1, max_depth: 8},
    ...
    test "detects low success rate performance issue" do
      performance_metrics = %{
        # Below 95%
        summary: %{overall_success_rate: 85.0, total_pipelines: 10, max_depth: 2},
        pipeline_metrics: [],
    ...
    test "calculates efficiency score" do
      performance_metrics = %{
        ...
        total_duration_ms: 5000,
        # 200MB peak
        resource_metrics: %{peak_memory_mb: 200.0},
        pipeline_metrics: []
      }
  ...
  describe "emit_performance_telemetry/2" do
    test "emits telemetry without errors" do
      ...
      assert :ok ==
               NestedPerformance.emit_performance_telemetry(performance_metrics, :custom_event)
    end
  end
  ...
  describe "performance calculations" do
    ...
    test "assesses scalability correctly" do
      ...
      # min of the two
      assert analysis.scalability_assessment.overall == :excellent

      # Poor scalability
      poor_scalability_metrics = %{
        # Very deep
        summary: %{max_depth: 15, total_pipelines: 20},
        # Very high memory
        resource_metrics: %{peak_memory_mb: 2500.0},
        pipeline_metrics: []
      }
  ...
  describe "resource analysis" do
    test "analyzes memory efficiency" do
      ...
      efficient_metrics = %{
        ...
        # 8MB per pipeline
        resource_metrics: %{peak_memory_mb: 80.0},
        pipeline_metrics: []
      }
      ...
      inefficient_metrics = %{
        ...
        # 120MB per pipeline
        resource_metrics: %{peak_memory_mb: 600.0},
        pipeline_metrics: []
      }
